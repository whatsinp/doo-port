        ...
        >
          ...
          <div class="px-6 py-4 border-b border-gray-100 dark:border-gray-700 flex justify-between items-center bg-gray-50/50 dark:bg-gray-800/50">
            <h2 class="text-xl font-bold text-gray-900 dark:text-white flex items-center gap-2">
              <i class="pi pi-wallet" :class="txType === 'BUY' ? 'text-green-500' : 'text-red-500'"></i> บันทึกธุรกรรม
            </h2>
            <button 
              @click="closeModal"
          ...
          <!-- Modal Body -->
          <form @submit.prevent="handleTransaction" class="p-6">
              ...
              <div v-if="!fixedPortfolioId">
                ...
                <div class="relative" ref="dropdownRef">
                  ...
                  >
                    ...
                    <i class="pi pi-chevron-down text-gray-400 transition-transform duration-200" :class="{ 'rotate-180': showDropdown }"></i>
                  </button>
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        ...
                        <i v-if="selectedPortfolioId === p.id" class="pi pi-check"></i>
                      </div>
                    </div>
                  </Transition>
                </div>
                <div v-if="portfolios.length === 0" class="mt-2 text-sm text-amber-500">
                  <i class="pi pi-info-circle"></i> คุณยังไม่มีพอร์ตการลงทุน กรุณาสร้างพอร์ตก่อนทำธุรกรรม
                </div>
              </div>
